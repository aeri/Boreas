 ...
 */
Tuple::Tuple(int dimension) { length = dimension; };
 ...
 */
string Tuple::get(int index) { return lindaTuple[index - 1]; };
 ...
 */
void Tuple::set(int index, string field) { lindaTuple[index - 1] = field; };

/**
 * Returns the dimension of the tuple
 * @return
 */
int Tuple::size() { return length; };
